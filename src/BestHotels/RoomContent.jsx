...
function RoomContent({image}) {
    return (
        <>
            <div className='bg-black shadow-xl w-1/4 best__hotel__box__sizing relative rounded-xl '>
                ...
                <div className='w-full bg-white rounded-xl p-8'>
                    ...
                    <button className='bg-teal-500 text-white text-lg rounded-md p-1 px-4'>Book Now</button>
                </div>
